...
A set of Python scripts to extract, translate, repack, and rebuild `.scd` files from certain Nintendo DS games (especially those using the "SCR\0" SCD container format). The tools are primarily designed for translation and fan localization projects.
